# -*- coding: utf-8 -*-
"""
Created on Tue Dec 21 20:37:01 2021
...
''' 
#old_label
with open("output/test_data_extract_OUTLIER.pickle", "rb") as fp:
    test_data = pickle.load(fp)

'''
#new_label
with open("output/test_data_extract_OUTLIER_newlabel.pickle", "rb") as fp:
    test_data = pickle.load(fp)
...
#處理完極端值，存檔
import pickle
with open("discrete_test_data_newLabel.pickle", "wb") as fp:   #Pickling
